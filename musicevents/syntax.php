 ...
 */
class syntax_plugin_musicevents extends DokuWiki_Syntax_Plugin {
...
//    }
    ...
    */
    function connectTo($mode) {
      ...
      $this->Lexer->addEntryPattern('<musicevent>',$mode,'plugin_musicevents');
    }


 
   function postConnect() {
     $this->Lexer->addExitPattern('</musicevent>','plugin_musicevents');
   }
